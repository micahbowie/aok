...
class ActsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create act" do
    assert_difference('Act.count') do
      post acts_url, params: { act: { giver: @act.giver, instagram_username: @act.instagram_username, message: @act.message, unique_identifier: @act.unique_identifier } }
    end
  ...
  test "should update act" do
    patch act_url(@act), params: { act: { giver: @act.giver, instagram_username: @act.instagram_username, message: @act.message, unique_identifier: @act.unique_identifier } }
